...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    subText: function subText(string) {
    ...
    getPosts: function getPosts() {
      ...
      axios.get("".concat(this.srvApi, "/api/posts?page=").concat(page)).then(function (res) {
        ...
        _this.posts.forEach(function (element) {
          element.subText = _this.subText(element.content);
        });
      })["catch"](function (err) {
        console.log(err);
      });
      ...
      _c(
        ...
        [
          ...
          _c("p", { staticClass: "card-text" }, [
            _vm._v(_vm._s(_vm.post.subText))
          ]),
          _vm._v(" "),
          _c(
            "router-link",
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("section", { staticClass: "text-info my-5 py-5" }, [
  ...
  return _vm.posts.length > 0
    ? _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "w-100 text-center my-3" }, [
            _c(
              "button",
              {
                directives: [
                ...
                staticClass: "btn btn-sm btn-sm btn-secondary",
                on: {
            ...
            _c(
              "div",
              {
                ...
                attrs: { role: "group", "aria-label": "pages" }
              },
              _vm._l(_vm.last_page, function(n) {
                return _c(
                  "button",
                  {
                    ...
                    class:
                      n == _vm.current_page ? "btn-secondary" : "btn-light",
                    on: {
                      click: function($event) {
...
var staticRenderFns = [
  function() {
    ...
    return _c("section", { staticClass: "my-5 text-center" }, [
      _c("h1", { staticClass: "text-danger" }, [_vm._v("404")]),
      _vm._v(" "),
      _c("h3", [_vm._v("Contenuto non trovato")])
    ])
  }
]
render._withStripped = true
...
module.exports = __webpack_require__(/*! /media/Dati/1_git_gzocchi/Laravel/laravel-boolpress/resources/js/front.js */"./resources/js/front.js");
